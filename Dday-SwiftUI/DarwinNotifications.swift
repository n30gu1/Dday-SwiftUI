...
public final class DarwinNotificationCenter {
    ...
    private let queue = DispatchQueue(label: "com.n30gu1.darwin-notificationcenter", qos: .default, attributes: [], autoreleaseFrequency: .workItem)
...
extension DarwinNotification.Name {
    ...
    private static var extensionDidSaveManagedObjectContext: DarwinNotification.Name {
        return DarwinNotification.Name("com.n30gu1.Dday-SwiftUI.extension-did-save")
    }
    ...
    private static var appDidSaveManagedObjectContext: DarwinNotification.Name {
        return DarwinNotification.Name("com.n30gu1.Dday-SwiftUI.app-did-save")
    }
}
